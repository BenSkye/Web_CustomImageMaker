...
export const MaterialModal = ({ contentList, day, unitName }) => {
        ...
        return (
          <Wrap>
            <WrapItem>
              {toast({
                title: `${
                  response.message ? response.message : 'Delete successfully'
                }`,
                position: 'top-right',
                isClosable: true,
                duration: 5000,
  ...
  return (
    <>
      <Button
        ...
        mx={'auto'}
      >
        <MdOutlineSnippetFolder name='icon' size={'2.8em'} />
      </Button>
      <Modal size={'3xl'} isCentered isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent borderBottomRadius={'20px'}>
          ...
          <ModalBody>
            <Flex fontSize={'xl'}>
              <Box w={'20%'}>
                <Text fontWeight={'bold'}>Unit {unitName}</Text>
              </Box>
              <Box w={'80%'}>
                ...
                <Flex key={e?.trainingMaterialId} w={'100%'} fontSize={'md'}>
                  ...
                  >
                    <Text width={'fit-content'} fontStyle={'italic'}>
                      By {e?.createBy} in {convertDateFormat(e?.createdDate)}
                    </Text>
                  </Box>
